...
import 'bootstrap-icons/font/bootstrap-icons.css'; // Good to have this imported if you use icons
...
        style={{ background: 'linear-gradient(to bottom right, #00332B 78%, gray 100%)' }} // Dark teal background
      >
        <div className="container">
...
                  <p className="small text-muted mb-3">
                    Simplify your payments, easily track contributions and receive automated transfers. Monitor your financial progress and manage 
                        your payouts anytime through your dashboard.
                  </p>
...
            <div className="col-lg-8">
              {/* Added a custom class for styling this specific table if needed */}
              <div className="table-responsive mb-4 koajo-comparison-table">
                <table className="table table-borderless text-start" style={{ backgroundColor: '#fff', borderRadius: '15px', overflow: 'hidden' }}>
                  <thead style={{ backgroundColor: '#e9ecef' }}>
                    <tr>
                      <th scope="col" className="py-3 px-3"></th> {/* Reduced px-4 to px-3 */}
                      <th scope="col" className="py-3 px-3">Koajo</th> {/* Reduced px-4 to px-3 */}
                      <th scope="col" className="py-3 px-3">Personal loans</th> {/* Reduced px-4 to px-3 */}
                      <th scope="col" className="py-3 px-3">Credit cards</th> {/* Reduced px-4 to px-3 */}
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="py-2 px-3 fw-bold small">No credit check required</td>
                      <td className="py-2 px-3 text-success fs-5"><i className="bi bi-check-circle-fill"></i></td> {/* Replaced ✓ with icon */}
                      <td className="py-2 px-3 text-danger fs-5"><i className="bi bi-x-circle-fill"></i></td> {/* Replaced ✗ with icon */}
                      <td className="py-2 px-3 text-danger fs-5"><i className="bi bi-x-circle-fill"></i></td> {/* Replaced ✗ with icon */}
                    </tr>
                    <tr>
                      <td className="py-2 px-3 fw-bold small">No hidden fees</td>
                      <td className="py-2 px-3 text-success fs-5"><i className="bi bi-check-circle-fill"></i></td> {/* Replaced ✓ with icon */}
                      <td className="py-2 px-3 text-success fs-5"><i className="bi bi-check-circle-fill"></i></td> {/* Replaced ✓ with icon */}
                      <td className="py-2 px-3 text-danger fs-5"><i className="bi bi-x-circle-fill"></i></td> {/* Replaced ✗ with icon */}
                    </tr>
                    <tr>
                      <td className="py-2 px-3 fw-bold small">No late fees</td>
                      <td className="py-2 px-3 text-success fs-5"><i className="bi bi-check-circle-fill"></i></td> {/* Replaced ✓ with icon */}
                      <td className="py-2 px-3 text-danger fs-5"><i className="bi bi-x-circle-fill"></i></td> {/* Replaced ✗ with icon */}
                      <td className="py-2 px-3 text-danger fs-5"><i className="bi bi-x-circle-fill"></i></td> {/* Replaced ✗ with icon */}
                    </tr>
                    <tr>
                      <td className="py-2 px-3 fw-bold small">No debt</td>
                      <td className="py-2 px-3 text-success fs-5"><i className="bi bi-check-circle-fill"></i></td> {/* Replaced ✓ with icon */}
                      <td className="py-2 px-3 text-danger fs-5"><i className="bi bi-x-circle-fill"></i></td> {/* Replaced ✗ with icon */}
                      <td className="py-2 px-3 text-danger fs-5"><i className="bi bi-x-circle-fill"></i></td> {/* Replaced ✗ with icon */}
                    </tr>
