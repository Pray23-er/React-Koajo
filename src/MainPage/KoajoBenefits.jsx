...
function KoajoBenefits() {
  // Custom Hook for animation (remains unchanged, correctly implemented)
  ...
  return (
    <>
      ...
      <section
        ...
        // Removed inline background style; will define in CSS
      >
            ...
            <div className="col-lg-8">
              <div className="row g-4">
                ...
                <div className="col-md-6">
                  <div className="d-flex align-items-start feature-card-item"> {/* Added feature-card-item */}
                    <div className="flex-shrink-0 me-3">
                      <i className="bi bi-coin feature-icon-lg"></i> {/* Added feature-icon-lg */}
                    </div>
                    <div className="feature-text-block"> {/* Added feature-text-block */}
                      <h4 className="fw-bold mb-1 feature-heading">Flexible for Every Financial Goal</h4> {/* Added feature-heading */}
      ...
      {/* Section 2: Financial security isn't just about wealth... (remains largely unchanged, but ensure CSS reflects gradient) */}
      <section
        ref={section2Ref}
    ...
    padding: '3rem'
            ...
            <div className="col-lg-4 col-md-6">
              <div className="card h-100 p-4 border-0 shadow-sm" style={{ borderRadius: '15px', backgroundColor: '#fff', color: '#343a40' }}>
                <div className="card-body">
                  ...
                  <div className="text-center my-3">
                    <i className="bi bi-currency-dollar" style={{ fontSize: '60px', color: '#004d40' }}></i>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="card h-100 p-4 border-0 shadow-sm" style={{ borderRadius: '15px', backgroundColor: '#fff', color: '#343a40' }}>
                <div className="card-body">
                  ...
                  <div className="text-center my-3">
                    <i className="bi bi-arrow-repeat" style={{ fontSize: '60px', color: '#004d40' }}></i>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Section 3: Koajo Vs How You used to do it */}
      <section
        ref={section3Ref}
                ...
                <table className="table table-borderless text-start" style={{ backgroundColor: '#fff', borderRadius: '15px', overflow: 'hidden' }}>
                  <thead style={{ backgroundColor: '#e9ecef' }}>
                    <tr>
                      ...
                      <th scope="col" className="py-3 px-3">Koajo</th>
                      <th scope="col" className="py-3 px-3">Personal loans</th>
                      <th scope="col" className="py-3 px-3">Credit cards</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
